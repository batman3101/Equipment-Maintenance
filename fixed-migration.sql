-- ================================================================
-- CNC 설비 관리 시스템 - 수정된 안전한 마이그레이션 스크립트
-- 의존성 해결 및 점진적 업그레이드
-- ================================================================
...
BEGIN
    ...
    ('breakdown_completed', 'breakdown', '수리 완료', 'Hoàn thành', 'Completed', 'bg-green-100 text-green-800', ARRAY[]::TEXT[]),
    ...
    ('repair_completed', 'repair', '수리 완료', 'Hoàn thành', 'Completed', 'bg-green-100 text-green-800', ARRAY[]::TEXT[]),
...
BEGIN
    ...
    RAISE NOTICE '=================================================================';
    RAISE NOTICE 'CNC 설비 관리 시스템 - 수정된 안전한 마이그레이션 완료';
    RAISE NOTICE '=================================================================';
    ...
    RAISE NOTICE '=================================================================';
    RAISE NOTICE '🎉 수정된 안전한 마이그레이션 완료! 핵심 설비 관리 기능을 이용하실 수 있습니다.';
    RAISE NOTICE '=================================================================';
END $$;