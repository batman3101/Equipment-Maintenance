      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-1">고장의 대분류를 관리합니다.</p>
          </div>
          <Button className="bg-blue-600 hover:bg-blue-700 text-white">새 고장 대분류 추가</Button>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {mainCategories.map((category) => (
            <Card key={category.id} className="p-6 card-hover transition-all duration-200 hover:shadow-lg">
        ...
        {mainCategories.length === 0 && (
          <div className="text-center py-12">
            <p className="text-gray-500 dark:text-gray-400 mb-4">등록된 고장 대분류가 없습니다.</p>
