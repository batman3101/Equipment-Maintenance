      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
        {settingsMenus.map((menu) => (
          <Link key={menu.href} href={menu.href}>
            <Card className="h-full hover:shadow-lg hover:scale-[1.02] dark:hover:shadow-2xl dark:hover:shadow-black/25 transition-all duration-300 ease-in-out cursor-pointer">
              <div className="p-6">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-gray-700">
                  <span className="text-sm text-gray-500 dark:text-gray-400">설정 관리</span>
                  <svg 
        ...
        <div className="mt-8 p-6 bg-gray-50 dark:bg-gray-800 rounded-lg">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="text-center">
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400">설비 종류</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-green-600 dark:text-green-400">
                {stats.equipment_statuses_count}
              </div>
              <div className="text-sm text-gray-600 dark:text-gray-400">설비 상태</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-orange-600 dark:text-orange-400">
                {stats.breakdown_main_categories_count}
              </div>
              <div className="text-sm text-gray-600 dark:text-gray-400">고장 대분류</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-purple-600 dark:text-purple-400">
                {stats.breakdown_sub_categories_count}
              </div>
              <div className="text-sm text-gray-600 dark:text-gray-400">고장 소분류</div>
            </div>
          </div>
        </div>
      )}
