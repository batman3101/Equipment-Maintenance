-- ================================================================
-- CNC 설비 관리 시스템 - 통합 마이그레이션 스크립트
-- 핵심 기능 중심, 부품재고/IoT 기능 제외
-- ================================================================
...
-- repair_reports에서 중복 equipment_id 제거 (관계 정리)
DO $$
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.columns 
        ...
        IF EXISTS (
            ...
            RAISE EXCEPTION '❌ repair_reports와 breakdown_reports 간 equipment_id 불일치 발견';
        END IF;
...
BEGIN
    ...
    RAISE NOTICE '=================================================================';
    RAISE NOTICE 'CNC 설비 관리 시스템 - 통합 마이그레이션 완료';
    RAISE NOTICE '=================================================================';
    ...
    RAISE NOTICE '✅ 성능 최적화 인덱스 (15개) 생성';
    ...
    RAISE NOTICE '=================================================================';
    RAISE NOTICE '🎉 시스템 구축 완료! 핵심 설비 관리 기능을 이용하실 수 있습니다.';
    RAISE NOTICE '=================================================================';
END $$;